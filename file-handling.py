# Tamer's FILE HANDLING Practice
...
file = open("practice.txt", "w") # <--The COMMAND for creating our "practice.txt" file.

file.write("WHUD'UP WORLD !!!\n")
file.write("This is Tamer, just cruising on by :/\n")
file.write("I have no idea HOW I FEEL :]")

# RESULT --> The file <practice.txt> is created and placed in the folder.

# -------------------------------------------------------------------

# <2> Read it back three different ways: read(), readline(), and iterate.

with open('practice.txt', 'r') as file:
    content = file.read()
    print(content)

# RESULT --> It spits out the content of the 'practice.txt' file'

# ---------------------------------------------------------------------

# <3> Make a function write_lines(path, lines) that writes each string in `lines` to `path`.
...
# RESULT --> 
# WHUD'UP WORLD !!!
# This is Tamer, just cruising on by :/
# I have no idea HOW I FEEL :

# ---------------------------------------------------------------------

# <4> Make a function tail(path, n=10) that prints the last n lines of a big text file efficiently.
